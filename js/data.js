  ...
  timeline: [
    ...
    },
    {
      ...
      text:
        ...
        "人見知りがひどかったにも関わらず、素敵なおじ様だけには抱っこされていたそうです！",
    },
    {
      stage: "学生時代",
      photos: [
      ...
      text:
        ...
        "高校時代はコーラス部に所属。音楽室でみんなと過ごした時間は私の青春です！<br>" +
        "短大では障害福祉で活躍できる保育士を目指して学び、恩師や大切な友人との出会いがありました🌱",
    },
    {
      stage: "社会人",
      photos: [
      ...
      text:
        "小さい頃から志していた福祉の道へ！<br>" +
        "セーナー苑の仕事、NPOでの保育士としての仕事、手話通訳者を目指しての学習、" +
        "友人や同僚との旅行やおでかけなど、仕事もプライベートも充実しています✨",
    },
  ],
};
